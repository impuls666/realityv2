                ...
                <div class="row">
                    <div class="col-md-3 col-sm-4">
                        <div class="search-box map">
                            ...
                            {!! Form::close() !!}
                            <div class="form-group">
                                <button type="submit" id="odoslatt" class="btn btn-default">Search Now</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function initMap() {
        ...
        $("#odoslatt").click(function(){
            var price = $("[name='price']").val();
            var kraj = $( "#kraj" ).val();
            console.log(price);
            console.log(kraj);

            $.ajax(downloadUrl("/data/price/"+price+"/kraj/"+kraj+"", function(data) {
